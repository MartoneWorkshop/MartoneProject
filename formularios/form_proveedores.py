...
class FormProv():
    ...
    def __init__(self, cuerpo_principal, permisos):
        ...
        self.tablaProveedores = ttk.Treeview(self.marco_prov, column=('codprov','nom_fiscal','rif_prov','nit_prov','tipo_per','email_prov',
                                                                    'telf_prov','dir_fiscal','dias_credito','data_created','data_update'), height=25)
        ...
        self.tablaProveedores.heading('#10',text="Date-Created")
        self.tablaProveedores.heading('#11',text="Date-Updated")
        ...
        self.tablaProveedores.column("#2", width=100, stretch=False)
        ...
        self.tablaProveedores.column("#7", width=60, stretch=False)
        self.tablaProveedores.column("#8", width=100, stretch=False)
        self.tablaProveedores.column("#9", width=100, stretch=False)
        self.tablaProveedores.column("#10", width=100, stretch=False)
        self.tablaProveedores.column("#11", width=100, stretch=False)

        for p in self.ListaProveedores:
            self.tablaProveedores.insert('',0,text=p[0], values=(p[1],p[2],p[3],p[4],p[5],p[6],p[7],p[8],p[9],p[10],p[11]))
